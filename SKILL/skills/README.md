...
| `detailed-design` | DDD tactical patterns in Rust, trait interface specification, struct layout design | DesignEngineer |
...
- `DesignEngineer`: architecture-governance, 8021x-domain-model, requirements-traceability
