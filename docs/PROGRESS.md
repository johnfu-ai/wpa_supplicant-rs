...
|---|---:|---:|---:|---:|---:|---|
| `pae` | 6 517 | 184 | 8 | 15 (MKA+CP+EAPOL-MKPDU) | 4 (PERF + PORT-002 + SEC-003) | Complete |
| `eapol-supp` | 2 546 | 64 | 4 | 14 (PAE + EAPOL + LOGON-003/004) | 1 (PERF-003) | Complete |
| `eap-peer` | 3 663 | 59 | 0 | 6 (EAP) | — | Unit-complete; interop pending |
| `logon` | 1 252 | 28 | 0 | 3 (LOGON-001/002/005) | — | Complete |
| `wpa-supplicant` (bin) | 2 087 | 93 | 0 | — | 6 (DEPLOY + REL-003) | ✅ Phase 07 V&V complete |
| **Total** | **16 065** | **428** | **12** | **37 / 37** | **25 / 25** | |
